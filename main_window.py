...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon22 = QIcon()
        icon22.addFile(u"../images/icons/skip_previous_FILL0_wght400_GRAD0_opsz48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon23 = QIcon()
        icon23.addFile(u"../images/icons/play_arrow_FILL0_wght400_GRAD0_opsz48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon23.addFile(u"images/icons/pause_FILL0_wght400_GRAD0_opsz48.png", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        ...
        icon24 = QIcon()
        icon24.addFile(u"../images/icons/skip_next_FILL0_wght400_GRAD0_opsz48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon25 = QIcon()
        icon25.addFile(u"../images/icons/subtitles_FILL0_wght400_GRAD0_opsz48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon26 = QIcon()
        icon26.addFile(u"../images/icons/music_note_FILL0_wght400_GRAD0_opsz48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon27 = QIcon()
        icon27.addFile(u"../images/icons/list_FILL0_wght400_GRAD0_opsz48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon28 = QIcon()
        icon28.addFile(u"../images/icons/fullscreen_FILL0_wght400_GRAD0_opsz48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
